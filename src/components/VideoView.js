...
const ICON_PLAY_BUTTON = new Icon(require("./assets/images/play_button.png"), 50, 50);
const ICON_PAUSE_BUTTON = new Icon(require("./assets/images/pause_button.png"), 64, 64);
const ICON_STOP_BUTTON = new Icon(require("./assets/images/stop_button.png"), 20, 22);
      ...
      <View style={styles.container}>
        ...
        <View style={styles.videoContainer}>
          <Video
            ...
            style={[
              styles.video,
              {
                opacity: this.state.showVideo ? 1.0 : 0.5,
        ...
        >
          ...
          <TouchableOpacity
            ...
            disabled={this.state.isLoading}
          >
            <Image source={ICON_FORWARD_BUTTON.module} style={styles.button}/>
          </TouchableOpacity>
        </View>
        <View
          style={[
